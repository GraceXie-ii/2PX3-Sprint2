...
class Intersection:
    def __init__(self):
        ...
        island_width = 2
        length = 95 #I have shortened the length of the entrance roads because vehicles base speeds are much lower because they are driving in a round about, however they would be able to drive faster in the entrance.
        radius = 18
        ...
        self.sim.create_quadratic_bezier_curve((62,-35),(65,-2),(80, -2.8))
        self.sim.create_quadratic_bezier_curve((52,-35),(50,-2),(30, -2.8))

        self.sim.create_quadratic_bezier_curve((40,-65),(2.8,-65),(2.8, -80))
        self.sim.create_quadratic_bezier_curve((40,-58),(2.8,-62),(2.8, -40))
